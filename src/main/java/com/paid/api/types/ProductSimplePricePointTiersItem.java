...
@JsonDeserialize(builder = ProductSimplePricePointTiersItem.Builder.class)
public final class ProductSimplePricePointTiersItem {
    ...
    private final Optional<ProductSimplePricePointTiersItemTierBillingType> tierBillingType;
    ...
    private ProductSimplePricePointTiersItem(
            Optional<Double> flatAmount,
            Optional<Double> index,
            double lowerBound,
            Optional<Double> number,
            Optional<ProductSimplePricePointTiersItemTierBillingType> tierBillingType,
    ...
    public Optional<ProductSimplePricePointTiersItemTierBillingType> getTierBillingType() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProductSimplePricePointTiersItem && equalTo((ProductSimplePricePointTiersItem) other);
    }
    ...
    private boolean equalTo(ProductSimplePricePointTiersItem other) {
    ...
    public interface LowerBoundStage {
        ...
        Builder from(ProductSimplePricePointTiersItem other);
    }

    public interface _FinalStage {
        ProductSimplePricePointTiersItem build();
        ...
        _FinalStage tierBillingType(Optional<ProductSimplePricePointTiersItemTierBillingType> tierBillingType);

        _FinalStage tierBillingType(ProductSimplePricePointTiersItemTierBillingType tierBillingType);
    ...
    public static final class Builder implements LowerBoundStage, _FinalStage {
        ...
        private Optional<ProductSimplePricePointTiersItemTierBillingType> tierBillingType = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(ProductSimplePricePointTiersItem other) {
        ...
        @java.lang.Override
        public _FinalStage tierBillingType(ProductSimplePricePointTiersItemTierBillingType tierBillingType) {
        ...
        public _FinalStage tierBillingType(Optional<ProductSimplePricePointTiersItemTierBillingType> tierBillingType) {
            this.tierBillingType = tierBillingType;
            return this;
        }
        ...
        @java.lang.Override
        public ProductSimplePricePointTiersItem build() {
            return new ProductSimplePricePointTiersItem(
                    flatAmount,
                    index,
                    lowerBound,
                    number,
