...
@JsonDeserialize(builder = ProductPricingTierOutput.Builder.class)
public final class ProductPricingTierOutput {
    ...
    private final Optional<ProductPricingTierOutputTierBillingType> tierBillingType;
    ...
    private ProductPricingTierOutput(
            Optional<Double> flatAmount,
            Optional<Double> index,
            double lowerBound,
            Optional<Double> number,
            Optional<ProductPricingTierOutputTierBillingType> tierBillingType,
    ...
    public Optional<ProductPricingTierOutputTierBillingType> getTierBillingType() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProductPricingTierOutput && equalTo((ProductPricingTierOutput) other);
    }
    ...
    private boolean equalTo(ProductPricingTierOutput other) {
    ...
    public interface LowerBoundStage {
        ...
        Builder from(ProductPricingTierOutput other);
    }

    public interface _FinalStage {
        ProductPricingTierOutput build();
        ...
        _FinalStage tierBillingType(Optional<ProductPricingTierOutputTierBillingType> tierBillingType);

        _FinalStage tierBillingType(ProductPricingTierOutputTierBillingType tierBillingType);
    ...
    public static final class Builder implements LowerBoundStage, _FinalStage {
        ...
        private Optional<ProductPricingTierOutputTierBillingType> tierBillingType = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(ProductPricingTierOutput other) {
        ...
        @java.lang.Override
        public _FinalStage tierBillingType(ProductPricingTierOutputTierBillingType tierBillingType) {
        ...
        public _FinalStage tierBillingType(Optional<ProductPricingTierOutputTierBillingType> tierBillingType) {
            this.tierBillingType = tierBillingType;
            return this;
        }
        ...
        @java.lang.Override
        public ProductPricingTierOutput build() {
            return new ProductPricingTierOutput(
                    flatAmount,
                    index,
                    lowerBound,
                    number,
