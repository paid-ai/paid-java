...
@JsonDeserialize(builder = ProductPricePointOutputTiersItem.Builder.class)
public final class ProductPricePointOutputTiersItem {
    ...
    private final Optional<ProductPricePointOutputTiersItemTierBillingType> tierBillingType;
    ...
    private ProductPricePointOutputTiersItem(
            Optional<Double> flatAmount,
            Optional<Double> index,
            double lowerBound,
            Optional<Double> number,
            Optional<ProductPricePointOutputTiersItemTierBillingType> tierBillingType,
    ...
    public Optional<ProductPricePointOutputTiersItemTierBillingType> getTierBillingType() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProductPricePointOutputTiersItem && equalTo((ProductPricePointOutputTiersItem) other);
    }
    ...
    private boolean equalTo(ProductPricePointOutputTiersItem other) {
    ...
    public interface LowerBoundStage {
        ...
        Builder from(ProductPricePointOutputTiersItem other);
    }

    public interface _FinalStage {
        ProductPricePointOutputTiersItem build();
        ...
        _FinalStage tierBillingType(Optional<ProductPricePointOutputTiersItemTierBillingType> tierBillingType);

        _FinalStage tierBillingType(ProductPricePointOutputTiersItemTierBillingType tierBillingType);
    ...
    public static final class Builder implements LowerBoundStage, _FinalStage {
        ...
        private Optional<ProductPricePointOutputTiersItemTierBillingType> tierBillingType = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(ProductPricePointOutputTiersItem other) {
        ...
        @java.lang.Override
        public _FinalStage tierBillingType(ProductPricePointOutputTiersItemTierBillingType tierBillingType) {
        ...
        public _FinalStage tierBillingType(Optional<ProductPricePointOutputTiersItemTierBillingType> tierBillingType) {
            this.tierBillingType = tierBillingType;
            return this;
        }
        ...
        @java.lang.Override
        public ProductPricePointOutputTiersItem build() {
            return new ProductPricePointOutputTiersItem(
                    flatAmount,
                    index,
                    lowerBound,
                    number,
