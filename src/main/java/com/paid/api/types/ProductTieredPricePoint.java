...
@JsonDeserialize(builder = ProductTieredPricePoint.Builder.class)
public final class ProductTieredPricePoint {
    ...
    @JsonProperty("tiers")
    public List<ProductTieredPricePointTiersItem> getTiers() {
        return tiers;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ProductTieredPricePoint && equalTo((ProductTieredPricePoint) other);
    }
    ...
    private boolean equalTo(ProductTieredPricePoint other) {
    ...
    public interface CurrencyStage {
        ...
        Builder from(ProductTieredPricePoint other);
    }
    ...
    public interface _FinalStage {
        ProductTieredPricePoint build();

        _FinalStage tiers(List<ProductTieredPricePointTiersItem> tiers);

        _FinalStage addTiers(ProductTieredPricePointTiersItem tiers);
    ...
    public static final class Builder implements CurrencyStage, UnitPriceStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ProductTieredPricePoint other) {
        ...
        @java.lang.Override
        public _FinalStage addAllTiers(List<ProductTieredPricePointTiersItem> tiers) {
            this.tiers.addAll(tiers);
            return this;
        }

        @java.lang.Override
        public _FinalStage addTiers(ProductTieredPricePointTiersItem tiers) {
        ...
        public _FinalStage tiers(List<ProductTieredPricePointTiersItem> tiers) {
            this.tiers.clear();
            this.tiers.addAll(tiers);
            return this;
        }
        ...
        @java.lang.Override
        public ProductTieredPricePoint build() {
            return new ProductTieredPricePoint(
