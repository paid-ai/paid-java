...
@JsonDeserialize(builder = PricingTierOutput.Builder.class)
public final class PricingTierOutput {
    ...
    private final Optional<PricingTierOutputTierBillingType> tierBillingType;
    ...
    private PricingTierOutput(
            Optional<Double> flatAmount,
            Optional<Double> index,
            double lowerBound,
            Optional<Double> number,
            Optional<PricingTierOutputTierBillingType> tierBillingType,
    ...
    public Optional<PricingTierOutputTierBillingType> getTierBillingType() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PricingTierOutput && equalTo((PricingTierOutput) other);
    }
    ...
    private boolean equalTo(PricingTierOutput other) {
    ...
    public interface LowerBoundStage {
        ...
        Builder from(PricingTierOutput other);
    }

    public interface _FinalStage {
        PricingTierOutput build();
        ...
        _FinalStage tierBillingType(Optional<PricingTierOutputTierBillingType> tierBillingType);

        _FinalStage tierBillingType(PricingTierOutputTierBillingType tierBillingType);
    ...
    public static final class Builder implements LowerBoundStage, _FinalStage {
        ...
        private Optional<PricingTierOutputTierBillingType> tierBillingType = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(PricingTierOutput other) {
        ...
        @java.lang.Override
        public _FinalStage tierBillingType(PricingTierOutputTierBillingType tierBillingType) {
        ...
        public _FinalStage tierBillingType(Optional<PricingTierOutputTierBillingType> tierBillingType) {
            this.tierBillingType = tierBillingType;
            return this;
        }
        ...
        @java.lang.Override
        public PricingTierOutput build() {
            return new PricingTierOutput(
                    flatAmount,
                    index,
                    lowerBound,
                    number,
