...
@JsonDeserialize(builder = PricingPricePointOutputTiersItem.Builder.class)
public final class PricingPricePointOutputTiersItem {
    ...
    private final Optional<PricingPricePointOutputTiersItemTierBillingType> tierBillingType;
    ...
    private PricingPricePointOutputTiersItem(
            Optional<Double> flatAmount,
            Optional<Double> index,
            double lowerBound,
            Optional<Double> number,
            Optional<PricingPricePointOutputTiersItemTierBillingType> tierBillingType,
    ...
    public Optional<PricingPricePointOutputTiersItemTierBillingType> getTierBillingType() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PricingPricePointOutputTiersItem && equalTo((PricingPricePointOutputTiersItem) other);
    }
    ...
    private boolean equalTo(PricingPricePointOutputTiersItem other) {
    ...
    public interface LowerBoundStage {
        ...
        Builder from(PricingPricePointOutputTiersItem other);
    }

    public interface _FinalStage {
        PricingPricePointOutputTiersItem build();
        ...
        _FinalStage tierBillingType(Optional<PricingPricePointOutputTiersItemTierBillingType> tierBillingType);

        _FinalStage tierBillingType(PricingPricePointOutputTiersItemTierBillingType tierBillingType);
    ...
    public static final class Builder implements LowerBoundStage, _FinalStage {
        ...
        private Optional<PricingPricePointOutputTiersItemTierBillingType> tierBillingType = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(PricingPricePointOutputTiersItem other) {
        ...
        @java.lang.Override
        public _FinalStage tierBillingType(PricingPricePointOutputTiersItemTierBillingType tierBillingType) {
        ...
        public _FinalStage tierBillingType(Optional<PricingPricePointOutputTiersItemTierBillingType> tierBillingType) {
            this.tierBillingType = tierBillingType;
            return this;
        }
        ...
        @java.lang.Override
        public PricingPricePointOutputTiersItem build() {
            return new PricingPricePointOutputTiersItem(
                    flatAmount,
                    index,
                    lowerBound,
                    number,
