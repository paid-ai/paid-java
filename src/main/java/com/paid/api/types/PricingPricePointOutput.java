...
@JsonDeserialize(builder = PricingPricePointOutput.Builder.class)
public final class PricingPricePointOutput {
    private final String currency;

    private final double unitPrice;

    private final Optional<List<PricingPricePointOutputTiersItem>> tiers;
    ...
    private PricingPricePointOutput(
            String currency,
            double unitPrice,
            Optional<List<PricingPricePointOutputTiersItem>> tiers,
    ...
    @JsonProperty("tiers")
    public Optional<List<PricingPricePointOutputTiersItem>> getTiers() {
        return tiers;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PricingPricePointOutput && equalTo((PricingPricePointOutput) other);
    }
    ...
    private boolean equalTo(PricingPricePointOutput other) {
    ...
    public interface CurrencyStage {
        ...
        Builder from(PricingPricePointOutput other);
    }
    ...
    public interface _FinalStage {
        PricingPricePointOutput build();

        _FinalStage tiers(Optional<List<PricingPricePointOutputTiersItem>> tiers);

        _FinalStage tiers(List<PricingPricePointOutputTiersItem> tiers);
    ...
    public static final class Builder implements CurrencyStage, UnitPriceStage, _FinalStage {
        ...
        private Optional<List<PricingPricePointOutputTiersItem>> tiers = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(PricingPricePointOutput other) {
        ...
        @java.lang.Override
        public _FinalStage tiers(List<PricingPricePointOutputTiersItem> tiers) {
        ...
        public _FinalStage tiers(Optional<List<PricingPricePointOutputTiersItem>> tiers) {
            this.tiers = tiers;
            return this;
        }

        @java.lang.Override
        public PricingPricePointOutput build() {
            return new PricingPricePointOutput(
