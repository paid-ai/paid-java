...
public final class Address {
    ...
    public interface ZipCodeStage {
        CountryStage zipCode(@NotNull String zipCode);
    }
    ...
    public static final class Builder
            implements Line1Stage, CityStage, StateStage, ZipCodeStage, CountryStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("zipCode")
        public CountryStage zipCode(@NotNull String zipCode) {
        ...
        public Address build() {
            return new Address(line1, line2, city, state, zipCode, country, additionalProperties);
        }
    }
}
