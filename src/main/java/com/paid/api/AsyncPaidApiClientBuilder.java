...
public class AsyncPaidApiClientBuilder {
     ...
     * Sets token
     */
    public AsyncPaidApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncPaidApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncPaidApiClientBuilder url(String url) {
     ...
     */
    public AsyncPaidApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncPaidApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncPaidApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncPaidApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncPaidApiClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncPaidApiClient(buildClientOptions());
    }
}
