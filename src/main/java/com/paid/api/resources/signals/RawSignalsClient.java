...
public class RawSignalsClient {
    protected final ClientOptions clientOptions;

    public RawSignalsClient(ClientOptions clientOptions) {
     ...
     */
    public PaidApiHttpResponse<SignalListResponse> listSignals() {
     ...
     * Returns ingested signals (usage events) for your organization, newest first. Filter by signal name, customer, product, and creation date range.
     */
    public PaidApiHttpResponse<SignalListResponse> listSignals(ListSignalsRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PaidApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SignalListResponse.class), response);
            }
     ...
     */
    public PaidApiHttpResponse<SignalListItem> getSignalById(String id) {
     ...
     * Get a single ingested signal (usage event) by its ID, including the data payload submitted at ingest.
     */
    public PaidApiHttpResponse<SignalListItem> getSignalById(String id, GetSignalByIdRequest request) {
     ...
     * Get a single ingested signal (usage event) by its ID, including the data payload submitted at ingest.
     */
    public PaidApiHttpResponse<SignalListItem> getSignalById(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PaidApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SignalListItem.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
                switch (response.code()) {
     ...
     */
    public PaidApiHttpResponse<BulkSignalsResponse> createSignals(BulkSignalsRequest request) {
        return createSignals(request, null);
    }

    /**
     * Create multiple signals (usage events) in a single request. Each signal must include a customer attribution (either customerId or externalCustomerId) and a product attribution (either productId or externalProductId).
     */
    public PaidApiHttpResponse<BulkSignalsResponse> createSignals(
            BulkSignalsRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("signals/bulk")
                .build();
        RequestBody body;
        try {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PaidApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), BulkSignalsResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
