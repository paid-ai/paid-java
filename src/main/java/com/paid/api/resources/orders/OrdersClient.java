...
public class OrdersClient {
     ...
     */
    public Order activateOrderById(String id) {
        return this.rawClient.activateOrderById(id).body();
    }

    /**
     * Activate a draft order by ID. Activation starts billing for the order using the same validation and side effects as the dashboard activation flow.
     */
    public Order activateOrderById(String id, ActivateOrderByIdRequest request) {
        return this.rawClient.activateOrderById(id, request).body();
    }

    /**
     * Activate a draft order by ID. Activation starts billing for the order using the same validation and side effects as the dashboard activation flow.
     */
    public Order activateOrderById(String id, ActivateOrderByIdRequest request, RequestOptions requestOptions) {
        return this.rawClient.activateOrderById(id, request, requestOptions).body();
    }
