...
public class AsyncRawCustomerPortalsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCustomerPortalsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerPortal>> createCustomerPortal() {
    ...
    public CompletableFuture<PaidApiHttpResponse<CustomerPortal>> createCustomerPortal(
        ...
        CompletableFuture<PaidApiHttpResponse<CustomerPortal>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new PaidApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CustomerPortal.class),
                                response));
                        return;
                    }
