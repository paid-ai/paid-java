...
public class AsyncRawCustomersClient {
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>> getCustomerFundingInstructions(
            String id) {
    ...
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>> getCustomerFundingInstructions(
        ...
        CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new PaidApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), CustomerFundingInstructions.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>> createCustomerFundingInstructions(
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>>
            getCustomerFundingInstructionsByExternalId(String externalId) {
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>>
            getCustomerFundingInstructionsByExternalId(
     ...
     */
    public CompletableFuture<PaidApiHttpResponse<CustomerFundingInstructions>>
            createCustomerFundingInstructionsByExternalId(
